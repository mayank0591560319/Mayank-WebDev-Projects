...
<body id="page-top">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
           <div class="portfolio-hover"> </div>
            <img class="img-fluid" src="<?php echo base_url(IMAGES); ?>/brands/images.png" alt="">
          </a>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
            <div class="portfolio-hover"></div>
            <img class="img-fluid" src="<?php echo base_url(IMAGES); ?>/brands/index0.png" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Vivo</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
            <div class="portfolio-hover"></div>
            <img class="img-fluid" src="<?php echo base_url(IMAGES); ?>/brands/images7.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Huawei</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
            <div class="portfolio-hover"></div>
            <img class="img-fluid" src="<?php echo base_url(IMAGES); ?>/brands/images3.png" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Apple</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
            <div class="portfolio-hover"></div>
            <img class="img-fluid" src="<?php echo base_url(IMAGES); ?>/brands/index3.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Oppo</h4>
          ...
          <ul class="timeline">
            <li>
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="<?php echo base_url(IMAGES); ?>/about/1.jpg" alt="">
              </div>
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="<?php echo base_url(IMAGES); ?>/about/2.jpg" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>March 2011</h4>
            ...
            <li>
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="<?php echo base_url(IMAGES); ?>/about/3.jpg" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>Today</h4>
  ...
  <div class="mapouter">
    <div class="gmap_canvas">
      <iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=weerakatiya%20bus%20stand&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>Google Maps Generator by <a href="https://www.embedgooglemap.net">embedgooglemap.net</a>
      </div>
      <style>
        .mapouter{
          position:relative;
 ...
 <br><br>
  ...
  <section class="page-section" id="contact">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form id="contactForm" name="sentMessage" novalidate="novalidate" method="POST" action="<?php echo base_url('resources/mail/contact_me.php');?>"> 
            <div class="row">
              <div class="col-md-6">
